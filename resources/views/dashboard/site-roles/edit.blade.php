            ...
            <div class="card-box">
                ...
                <div class="breadcrumb">
                    <a href="{{route('admin.main')}}" class="header-title m-t-0 m-b-30"><i class="icon-home2 mr-2"></i>
                        الرئيسية</a> /
                    <a href="{{route('admin.site-roles.index')}}" class="header-title m-t-0 m-b-30"><i
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data"
                                  action="{{route('admin.site-roles.update',$role->id)}}">
                                @csrf
                                {{method_field('put')}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input name="name" placeholder="الاسم  " value="{{ $role->name }} "
                                ...
                                <div class="form-group row">
                                    ...
                                    @if($role->image)
                                        ...
                                        <a data-fancybox="gallery" href="{{$role->image}}">
                                            <img src="{{$role->image}}" width="100" height="100" class="img-thumbnail">
                                        </a>
