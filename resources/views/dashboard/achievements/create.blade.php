...
@section('title',' اضافة تقرير جديد ')
            ...
            <div class="card-box">
                ...
                <div class="breadcrumb">
                    <a href="{{route('admin.main')}}" class="header-title m-t-0 m-b-30"><i class="icon-home2 mr-2"></i>
                        الرئيسية</a> /
                    <a href="{{route('admin.achievements.index')}}" class="header-title m-t-0 m-b-30"><i
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="header-title m-t-0 m-b-30"> اضافة تقرير</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file"
                                               ...
                                               name="files[]" multiple>
                                        <small class="text-info font-bold">يمكنك اختيار ملف واحد او أكثر</small>
                                        @error('files')
                                        <div class="invalid-feedback" style="color: #ef1010">
                                            {{ $message }}
                                        </div>
