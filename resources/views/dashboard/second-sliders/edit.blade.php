                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data"
                                  action="{{route('admin.second-sliders.update',$secondSlider->id)}}">
                                @csrf
                                {{method_field('put')}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input name="title" placeholder="العنوان  " value="{{ $secondSlider->title }} "
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="body" cols="30" rows="4" placeholder="المحتوى"
                                                  class="form-control {{$errors->has('body') ? ' is-invalid' : null}}">{{$secondSlider->body}}</textarea>
                                        @error('body')
                                        <div class="invalid-feedback" style="color: #ef1010">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    @if($secondSlider->image)
                                        ...
                                        <a data-fancybox="gallery" href="{{$secondSlider->image}}">
                                            <img src="{{$secondSlider->image}}" width="100" height="100" class="img-thumbnail">
                                        </a>
