                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <a href="{{route('admin.second-sliders.create')}}"
                                ...
                                @foreach($sliders as $index => $slider)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form
                                                action="{{ route('admin.active', ['id' => $slider->id, 'type' => 'SecondSlider']) }}"
                                            ...
                                            <a href="{{url(route('admin.second-sliders.edit',$slider->id))}}"
                                               class="btn-icon waves-effect btn btn-primary btn-sm ml-2 rounded-circle"><i
                                                    class="fa fa-edit"></i></a>


                                            <button data-url="{{route('admin.second-sliders.destroy',$slider->id)}}"
