                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data"
                                  action="{{route('admin.donates.update',$donate->id)}}">
                                @csrf
                                {{method_field('put')}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input name="name" placeholder="الاسم  " value="{{ $donate->name }} "
                                ...
                                <div class="form-group row">
                                    ...
                                    @if($donate->image)
                                        ...
                                        <a data-fancybox="gallery" href="{{$donate->image}}">
                                            <img src="{{$donate->image}}" width="100" height="100" class="img-thumbnail">
                                        </a>
